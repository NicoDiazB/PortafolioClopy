...
<footer
    ...
    >
      ...
      <div className='text-xs' >
        ...
        <a className=' hover:text-[#4B70A6]' target='_blank' href={"https://creativecommons.org/licenses/by-sa/4.0/"}>{t("licenseLink")}</a>
      </div>
        <a className=' hover:text-[#4B70A6]'  target='_blank' href='https://www.linkedin.com/in/nicolas-diaz-99944b232/'> {t("developedBy")}</a>
    </footer>
  )
}

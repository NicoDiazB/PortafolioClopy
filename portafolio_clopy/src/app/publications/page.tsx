...
function Publications() {
  return (
    <section className='pt-40 md:pt-60'>
        <h1 className='text-4xl font-bold text-center mb-6'>Publicaions</h1>
        <ol className='text-center text-lg px-4 max-w-[1000px] mx-auto flex flex-col gap-6'>
            <li className='list-decimal leading-tight '>

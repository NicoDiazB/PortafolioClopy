  ...
  return (
    <section className='pt-40 md:pt-60'>
        ...
        <ol className='text-start text-lg px-4 max-w-[1000px] font-mono mx-auto flex flex-col gap-8'>
            ...
            <li className='md:text-xl list-decimal leading-tight'>
               Sion, Y., Diaz Reyes, C., Lamas, D., & Mokhalled, M. (2023, February). Vibmory-Mapping Episodic Memories to Vibrotactile Patterns.<em className='font-[italic]' > In Proceedings of the Seventeenth International Conference on Tangible, Embedded, and Embodied Interaction </em>(pp. 1-12). <a className=' underline text-[#4B70A6]' href="https://doi.org/10.1145/3569009.3572747">https://doi.org/10.1145/3569009.3572747</a>
            </li>
            <li className='md:text-xl list-decimal leading-tight'>
                Campos, I., Fuchs, D., Repo, P., Jager, W., Klöckner, C., Wang, S., Lamas, D., Cots, F., Barchiesi, E., Löfström, E., Peniche, D., Sion, Y., Buth, V., Limão, J., Oliveira, S., Diaz, C. R., & Živčič, L. (2024). What roles can democracy labs play in co-creating democratic innovations for sustainability?<em className='font-[italic]' > Socio-Ecological Practice Research. </em> <a className='  underline text-[#4B70A6]' href="https://doi.org/10.1007/s42532-024-00197-7">https://doi.org/10.1007/s42532-024-00197-7</a>
            </li>
            <li className='md:text-xl list-decimal leading-tight'>
                Diaz Reyes, C & Vračarević, S (2025, September 3-6). <em className='font-[italic]' >Sensing Connections.</em> [Presentation Open Panel with Intervention Co-razonar] 4S Annual Meeting (Society for Social Studies of Science), Seattle, WA, United States. 
            </li>
        </ol>
